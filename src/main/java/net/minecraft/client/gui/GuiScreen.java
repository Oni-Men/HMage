...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
  ...
  /**
   * Adds a control to this GUI's button list. Any type that subclasses button may be added (particularly, GuiSlider, but not text fields).
   *
  ...
  protected void handleComponentHover(ITextComponent component, int x, int y) {
    if (component != null && component.getStyle().getHoverEvent() != null) {
      ...
      if (hoverevent.getAction() == HoverEvent.Action.SHOW_ITEM) {
        ...
        this.drawHoveringText(this.mc.fontRenderer.listFormattedStringToWidth(hoverevent.getValue().getFormattedText(),
            Math.max(this.width / 2, 200)), x, y);
      }
  ...
  public void drawWorldBackground(int tint) {
    if (this.mc.world != null) {
      this.drawGradientRect(0, 0, this.width, this.height, Preferences.guiBgColorStart, Preferences.guiBgColorEnd);
    } else {
